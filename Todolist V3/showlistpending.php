...
$totalRows_todolist = mysql_num_rows($todolist);mysql_select_db($database_myconnect, $myconnect);
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="showlistpendingTH.php">THAI LANGUAGE</a></li>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <h1 style="color:#FFF">List Pending</h1>
    <hr>
     <?php do { ?>
