...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <h1 style="color:#FFF">All List</h1>
    <hr>
       	<div class="tab">
...
<?php if($_SESSION['MM_Username']==$row_user['UserName']){?>
  ...
  <table class="table">
    ...
    <tr>
      ...
      <td><label for="text" style="color:#000;font-size:14px" type="button" data-toggle="collapse" data-target="#<?php echo $row_todolist['idToDoList']; ?>">Detail</label><div id="<?php echo $row_todolist['idToDoList']; ?>" class="collapse">
      <label for="text" style="color:#000;font-size:14px">Category :
...
<?php if($_SESSION['MM_Username']==$row_user1['UserName']){?>
  ...
  <table class="table">
    ...
    <tr>
      ...
      <td><textarea class="form-control" style="color:#000;font-size:14px" cols="25" rows="2" disabled><?php echo $row_todolist1['decription']; ?></textarea></td>
      <td><label for="text" style="color:#000;font-size:14px"><?php echo $row_todolist1['Status']; ?></label></td>
      
      <td><a href="Edit.php?id=<?php echo $row_todolist1['idToDoList']; ?>"><label for="text" style="color:#000;font-size:14px">Edit <span class="glyphicon glyphicon-cog"></span></label></a> <label for="text" style="color:#000;font-size:14px">|</label>  <a href="delete.php?id=<?php echo $row_todolist1['idToDoList']; ?>" onClick="remove()"><label for="text" style="color:#000;font-size:14px">Remove <span class="glyphicon glyphicon-trash"></span></label></a></td>
      <td><label for="text" style="color:#000;font-size:14px" type="button" data-toggle="collapse" data-target="#<?php echo $row_todolist1['idToDoList']; ?>1">Detail</label><div id="<?php echo $row_todolist1['idToDoList']; ?>1" class="collapse">
	...
	<tr>
      ...
      <td><a href="delete.php?id=<?php echo $row_todolist1['idToDoList']; ?>" onClick="remove()"><label for="text" style="color:#000;font-size:14px">Remove <span class="glyphicon glyphicon-trash"></span></label></a></td>
      <td><label for="text" style="color:#000;font-size:14px" type="button" data-toggle="collapse" data-target="#<?php echo $row_todolist1['idToDoList']; ?>2">Detail</label><div id="<?php echo $row_todolist1['idToDoList']; ?>2" class="collapse">
      <label for="text" style="color:#000;font-size:14px">
      Category :
      <?php if($row_todolist1['category']=="Workplace") {?>
      Workplace<br>
