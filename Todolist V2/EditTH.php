...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onSubmit="return fndate()">
      	...
      	<input type="text" name="name" value="<?php echo htmlentities($row_todolist['name'], ENT_COMPAT, 'utf-8'); ?>" size="32"><br>
      	<label>วันที่ :</label>
    	<input type="date" name="date" id="date" value="<?php echo htmlentities($row_todolist['date'], ENT_COMPAT, 'utf-8'); ?>" size="32">
        <input type="date" name="date1" id="date1" value="<?php echo date('Y-m-d');?>" hidden="hidden"><br>
        <label>รายละเอียด</label><br>
        <textarea name="decription" id="decription" rows="10" cols="50"><?php echo htmlentities($row_todolist['decription'], ENT_COMPAT, 'utf-8'); ?></textarea><br>
