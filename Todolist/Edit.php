...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE todolist SET name=%s, `date`=%s, decription=%s, Status=%s, User_idUser=%s WHERE idToDoList=%s",
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
    	...
    	<input type="date" name="date" value="<?php echo htmlentities($row_todolist['date'], ENT_COMPAT, 'utf-8'); ?>" size="32"><br>
        ...
        <select name="Status" id="Status">
          ...
          <input type="submit" value="Edit Task" onClick="edit()">
