...
mysql_select_db($database_myconnect, $myconnect);
$query_todolist1 = "SELECT * FROM todolist ORDER BY priority DESC";
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <h1 style="color:#FFF">รายการทั้งหมด</h1>
    <hr>
       <div class="tab">
...
<?php if($_SESSION['MM_Username']==$row_user['UserName']){?>
  ...
  <table class="table">
    ...
    <tr>
      ...
      <td><label type="button" data-toggle="collapse" data-target="#<?php echo $row_todolist['idToDoList']; ?>" for="text" style="color:#000;font-size:14px">รายละเอียดต่างๆ</label><div id="<?php echo $row_todolist['idToDoList']; ?>" class="collapse">
     <label for="text" style="color:#000;font-size:14px"> หมวดหมู่ :
...
<?php if($_SESSION['MM_Username']==$row_user1['UserName']){?>
  ...
  <table class="table" >
    ...
    <tr>
      ...
      <td><label for="text" style="color:#000;font-size:14px"><?php echo $row_todolist1['name']; ?></label></td>
      <td><label for="text" style="color:#000;font-size:14px"><?php echo $row_todolist1['date']; ?></label></td>
      <td><textarea class="form-control" cols="25" rows="2" disabled style="color:#000;font-size:14px"><?php echo $row_todolist1['decription']; ?></textarea></td>
      <td><label for="text" style="color:#000;font-size:14px">รอดำเนินการ</label></td>
      <td><a href="EditTH.php?id=<?php echo $row_todolist1['idToDoList']; ?>"><label for="text" style="color:#000;font-size:14px">แก้ไข  <span class="glyphicon glyphicon-cog"></span></label></a> <label for="text" style="color:#000;font-size:14px">|</label>  <a href="deleteTH.php?id=<?php echo $row_todolist1['idToDoList']; ?>" onClick="remove()"><label for="text" style="color:#000;font-size:14px">ลบ <span class="glyphicon glyphicon-trash"></span></label></a></td>
      <td><label for="text" style="color:#000;font-size:14px" type="button" data-toggle="collapse" data-target="#<?php echo $row_todolist1['idToDoList']; ?>1">รายละเอียดต่างๆ</label><div id="<?php echo $row_todolist1['idToDoList']; ?>1" class="collapse">
	...
	<tr>
      ...
      <td><label for="text" style="color:#000;font-size:14px"><?php echo $row_todolist1['date']; ?></label></td>
      <td><textarea class="form-control" cols="25" rows="2" disabled style="color:#000;font-size:14px"><?php echo $row_todolist1['decription']; ?></textarea></td>
      <td><label for="text" style="color:#000;font-size:14px">เสร็จสมบูรณ์</label></td>
      <td><a href="deleteTH.php?id=<?php echo $row_todolist1['idToDoList']; ?>" onClick="remove()"><label for="text" style="color:#000;font-size:14px">ลบ  <span class="glyphicon glyphicon-trash"></span></label></a></td>
      <td><label for="text" style="color:#000;font-size:14px" type="button" data-toggle="collapse" data-target="#<?php echo $row_todolist1['idToDoList']; ?>2">รายละเอียดต่างๆ</label><div id="<?php echo $row_todolist1['idToDoList']; ?>2" class="collapse">
      <label for="text" style="color:#000;font-size:14px">
      หมวดหมู่ :
      <?php if($row_todolist1['category']=="Workplace") {?>
      งานที่ทำงาน<br>
