...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <h1 style="color:#FFF">แก้ไขงาน</h1>
    <hr>
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>" onSubmit="return fndate()">
      	<div class="row">
    <div class="col-sm-4">
    <label for="text" style="color:#FFF;font-size:20px">ชื่องาน :</label>
      	<input class="form-control" type="text" name="name" value="<?php echo htmlentities($row_todolist['name'], ENT_COMPAT, 'utf-8'); ?>" size="32"></div></div><br>
      	<div class="row">
    <div class="col-sm-4">
    <label for="text" style="color:#FFF;font-size:20px">  วันที่ &nbsp;:</label>
        ...
        <div class="row">
    <div class="col-sm-4">
    <label for="text"  style="color:#FFF;font-size:20px">รายละเอียด :</label><br>
        ...
        <div class="row">
    <div class="col-sm-4">
    <label for="text" style="color:#FFF;font-size:20px" >หมวดหมู่ :</label>
    ...
    <div class="row">
    <div class="col-sm-4">
    <label for="text"  style="color:#FFF;font-size:20px" >มีความสำคัญ :</label>
    ...
    <br ><div class="row">
    <div class="col-sm-4">
    <label for="text"  style="color:#FFF;font-size:20px" >สถานะ   :</label>
        
        <select class="form-control" name="Status" id="Status">
          <option value="pending" selected="selected">รอดำเนินการ</option>
          ...
          <input class="btn btn-default" type="submit" value="แก้ไขงาน">
