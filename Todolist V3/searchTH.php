  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="search.php">ภาษาอังกฤษ</a></li>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <h1 style="color:#FFF">ผลการค้นหา</h1> 
    <hr>
     <?php do { ?>
<?php if($_SESSION['MM_Username']==$row_user['UserName']){?>
  ...
  <table class="table" >
	...
	<tr>
      ...
      <td><a href="deleteTH.php?id=<?php echo $row_todolist['idToDoList']; ?>" onClick="remove()"><label for="text" style="color:#000;font-size:14px">ลบ  <span class="glyphicon glyphicon-trash"></span></label></a></td>
      <td><label for="text" style="color:#000;font-size:14px" type="button" data-toggle="collapse" data-target="#<?php echo $row_todolist['idToDoList']; ?>2">รายละเอียดต่างๆ</label><div id="<?php echo $row_todolist['idToDoList']; ?>2" class="collapse">
      <label for="text" style="color:#000;font-size:14px">
      หมวดหมู่ :
      <?php if($row_todolist['category']=="Workplace") {?>
      งานที่ทำงาน<br>
