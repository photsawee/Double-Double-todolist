...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="container">
    <h1 style="color:#FFF">เพิ่มงาน</h1>
    <hr>
    <form method="POST" action="<?php echo $editFormAction; ?>" name="form" onSubmit="return fndate()">
    
    <div class="row">
    <div class="col-sm-4">
    <label for="text" style="color:#FFF;font-size:20px">ชื่องาน :</label><input type="text" name="listname" required class="form-control" placeholder="Name List">
    </div>
    </div>
    <br>
    <div class="row">
    ...
    <textarea name="area" rows="10" cols="50" class="form-control" placeholder="Description"></textarea>
    </div>
    </div>
    <br >
    <div class="row">
    ...
    <option value="3" >มีความสำคัญมาก</option>
    <option value="2" selected>มีความสำคัญปานกลาง</option>
    ...
    <button type="submit" class="btn btn-default" onClick="add()">เพิ่มงาน</button>
