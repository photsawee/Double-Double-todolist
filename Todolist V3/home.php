...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <hr>
    <p style="font-size:18px;color:#FFF">How to use<br></p><p style="font-size:18px;color:#FFF">You can add jobs at add task.<br>You can check all the items at All items.<br>You can check out Pending Items at Pending Items.<br>You can review the completed work items at Completed Items.<br>You can find jobs at the search.</p>
    </div>
